...
import net.felinamods.hg.init.HgModTabs;
import net.felinamods.hg.init.HgModSounds;
import net.felinamods.hg.init.HgModParticleTypes;
import net.felinamods.hg.init.HgModMenus;
...
@Mod("hg")
public class HgMod {
	public static final Logger LOGGER = LogManager.getLogger(HgMod.class);
	public static final String MODID = "hg";

	public HgMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		HgModSounds.REGISTRY.register(modEventBus);

		HgModItems.REGISTRY.register(modEventBus);
		HgModEntities.REGISTRY.register(modEventBus);
		HgModTabs.REGISTRY.register(modEventBus);
		HgModVariables.ATTACHMENT_TYPES.register(modEventBus);

		HgModMenus.REGISTRY.register(modEventBus);
		HgModParticleTypes.REGISTRY.register(modEventBus);
	...
	public static record GuiSyncMessage(String editbox, String value) implements CustomPacketPayload {
		public static final Type<GuiSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(HgMod.MODID, "gui_sync"));
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									HgMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class GuiSyncInit {
		...
		public static void init(FMLCommonSetupEvent event) {
			HgMod.addNetworkMessage(GuiSyncMessage.TYPE, GuiSyncMessage.STREAM_CODEC, GuiSyncMessage::handleData);
		}
	}
}
