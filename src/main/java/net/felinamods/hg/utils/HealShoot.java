...
public class HealShoot {
    ...
    public static void heal(Level world, Entity shooter, double maxDistance, float baseDamage,
...
public static void healEntity(LivingEntity entity, float amount) {
    ...
    SoundUtils.playServerSound(entity.level(), ResourceLocation.parse("fels_firearms_wwi:syringe_action"), entity.position(), 1.0f, 1.0f);   
}
