...
public class ExplosionUtil {
   ...
   public static void onEntityCollide(Entity caller, float damageAmount, double spaceX, double spaceY, double spaceZ) {
      // Define the collision box around the caller
      AABB collisionBox = caller.getBoundingBox().inflate(7.0D, 7.0D, 7.0D);
