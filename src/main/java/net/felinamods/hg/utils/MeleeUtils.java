...
public class MeleeUtils {
    ...
    public static void shootBullet(Level world, Entity shooter, double maxDistance, float baseDamage,
        ...
        for (Entity entity : entities) {
            ...
            // Apply hitmarker
            PlayerVariables vars = (PlayerVariables) shooter.getData(HgModVariables.PLAYER_VARIABLES);
            vars.hitmarker = true;
		   ...
		   // _vars2.syncPlayerVariables(entity);
            ...
            SoundUtils.playServerSound(world, ResourceLocation.parse("fels_firearms_wwi:bayonet_stab"), shooter.position(), 1.0f, 1.0f);
        ...
        if (bulletStopped || blockHit.getType() == Type.BLOCK || pierceCount == 0) {
            //SpawnNormalBulletProcedure.execute(world, finalHitPos.x, finalHitPos.y, finalHitPos.z);
        }
    }
}
