...
public class Gp31Layer extends GeoRenderLayer<Gp31Item> {
	private static final ResourceLocation LAYER = ResourceLocation.parse("hg:textures/item/f_gp31.png");

	public Gp31Layer(GeoRenderer<Gp31Item> renderer) {
		super(renderer);
	}

@Override
public void render(PoseStack poseStack, Gp31Item animatable, BakedGeoModel bakedModel,
