...
public class AR2ItemModel extends GeoModel<AR2Item> {
	...
	public ResourceLocation getAnimationResource(AR2Item animatable) {
		return ResourceLocation.parse("hg:animations/ar2.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(AR2Item animatable) {
		return ResourceLocation.parse("hg:geo/ar2.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(AR2Item animatable) {
		return ResourceLocation.parse("hg:textures/item/ar2.png");
	}

	@Override
	public void setCustomAnimations(AR2Item animatable, long instanceId, AnimationState<AR2Item> animationState) {
