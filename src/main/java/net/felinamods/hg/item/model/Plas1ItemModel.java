...
public class Plas1ItemModel extends GeoModel<Plas1Item> {
	@Override
	public ResourceLocation getAnimationResource(Plas1Item animatable) {
		return ResourceLocation.parse("hg:animations/plas1.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(Plas1Item animatable) {
		return ResourceLocation.parse("hg:geo/plas1.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(Plas1Item animatable) {
		return ResourceLocation.parse("hg:textures/item/plas1.png");
	}

	@Override
	public void setCustomAnimations(Plas1Item animatable, long instanceId, AnimationState<Plas1Item> animationState) {
