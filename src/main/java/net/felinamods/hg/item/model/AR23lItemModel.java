...
public class AR23lItemModel extends GeoModel<AR23lItem> {
	@Override
	public ResourceLocation getAnimationResource(AR23lItem animatable) {
		return ResourceLocation.parse("hg:animations/ar23.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(AR23lItem animatable) {
		return ResourceLocation.parse("hg:geo/ar23.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(AR23lItem animatable) {
		return ResourceLocation.parse("hg:textures/item/ar23.png");
	}

	@Override
	public void setCustomAnimations(AR23lItem animatable, long instanceId, AnimationState<AR23lItem> animationState) {
